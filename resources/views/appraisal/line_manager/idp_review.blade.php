                    ...
                    <table class="table table-bordered align-middle mb-0 excel-style">
                        <thead style="background-color: #f8fbff; color: #1a6b3b;">
                            <tr>
                                ...
                                <th style="min-width: 150px;" class="small">Tracking Indicator</th>
                                <th style="min-width: 200px;" class="small">Action points agreed during Midterm</th>
                        ...
                        <tbody>
                            <template x-for="(row, index) in rows" :key="index">
                                <tr>
                                    ...
                                    <td class="p-0">
                                        <textarea x-model="row.action_points_agreed" class="form-control border-0 shadow-none excel-textarea py-1" style="font-size: 0.75rem;" rows="2" placeholder="Action points..."></textarea>
                                    </td>
