...
@section('content')
    ...
    <x-ui.datatable-card title="Team IDPs" subtitle="{{ $fyLabel ? 'Active FY: ' . $fyLabel : 'All financial years' }}" icon="fa-graduation-cap"
        body-class="p-0">
        <x-slot name="actions">
            ...
            <button class="btn btn-sm btn-outline-secondary" type="button"
                onclick="AutoRefresh.manualRefresh('lm-idps-table-container')">
                <i class="fas fa-rotate me-1"></i> Refresh
            </button>
        </x-slot>

        <div id="lm-idps-table-container" data-auto-refresh="true" data-refresh-url="{{ route('idp.team.list') }}"
            data-refresh-target="#lm-idps-table-container">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a class="btn btn-sm btn-outline-primary shadow-none"
                                        href="{{ route('idp.team.review', $firstIdp) }}">
